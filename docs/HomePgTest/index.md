...
/_ W3.CSS 5.02 March 31 2025 by Jan Egil and Borge Refsnes _/
html{box-sizing:border-box}_,_:before,_:after{box-sizing:inherit}
/_ Extract from normalize.css by Nicolas Gallagher and Jonathan Neal git.io/normalize _/
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    ...
    <div class="w3-col l4 m6">
      <img src="app001.jpg" class="w3-image w3-right w3-hide-small" width="335" height="471">
      <div class="w3-center w3-hide-large w3-hide-medium">
        <button class="w3-button w3-block w3-padding-large" onclick="document.getElementById('download').style.display='block'">
          <i class="fa fa-download"></i> Download Application
        </button>
        <img src="app001.jpg" class="w3-image w3-margin-top" width="335" height="471">
      </div>
    </div>
  </div>
</div>
...
<div class="w3-padding-64 w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col l4 m6">
      <img class="w3-image w3-round-large w3-hide-small w3-grayscale" src="app5.jpg" alt="App" width="335" height="471">
    </div>
    <div class="w3-col l8 m6">
...
<div class="w3-container w3-padding-64 w3-dark-grey w3-center">
  ...
  <div class="w3-row" style="margin-top:64px">
    <div class="w3-col s3">
      <a href="../../../AboutMe.md" style="color: white"><i class="fa fa-bolt w3-text-orange w3-jumbo"></i>
      <p>About me</p></a>
    </div>
    <div class="w3-col s3">
      <a href="..01ApiAiTools/index.md" style="color: white"><i class="fa fa-heart w3-text-red w3-jumbo"></i>
      <p>API, AI, Tools</p></a>
    </div>
    <div class="w3-col s3">
